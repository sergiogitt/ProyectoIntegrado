...
console.log(capacidadVentilacion2)
  ...
  visualzacion.push(<ComponenteConfigurador indice={5} nombre={"Torre"} setEstructura={setestructuraTorre} tabla={"torre"} seleccionado={componentes[5]} setSeleccionado={(a, b) => cambiarSeleccionado(a, b)} cambiarPrecioTotal={(a, b, c, d) => cambiarPrecioTotal(a, b, c, d)}></ComponenteConfigurador>)
  ...
  visualzacion.push(<ComponenteConfigurador indice={8} nombre={"Cooler procesador"} tabla={"cooler_procesador"} seleccionado={componentes[8]} setSeleccionado={(a, b) => cambiarSeleccionado(a, b)} cambiarPrecioTotal={(a, b, c, d) => cambiarPrecioTotal(a, b, c, d)}></ComponenteConfigurador>)
  ...
  return (<div>
    {(!cargando) ? <div id="configurador"><div id="componentes">{visualzacion}</div><div id="errores">{errores}</div></div> : <div class="spinner"><Spinner animation="border" role="status">
